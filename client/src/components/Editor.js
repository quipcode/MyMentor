...
// Render editor
export default ({mode, theme, onChange, fontSize,enableLiveAutocompletion ,wordWrap, value}) => (
    <AceEditor
    mode={mode}
    theme={theme}
    onChange={onChange}
    ...
    setOptions={{cursorStyle: "smooth", enableLiveAutocompletion: enableLiveAutocompletion}}
  />  
);